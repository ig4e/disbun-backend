...
import { UserProfileUploadUncheckedUpdateManyWithoutUserNestedInput } from '../user-profile-upload/user-profile-upload-unchecked-update-many-without-user-nested.input';
...
@InputType()
export class UserUncheckedUpdateWithoutMessageMentionInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    id?: StringFieldUpdateOperationsInput;

    @Field(() => UserProfileUploadUncheckedUpdateManyWithoutUserNestedInput, {nullable:true})
    profileUploads?: UserProfileUploadUncheckedUpdateManyWithoutUserNestedInput;
