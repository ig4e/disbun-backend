...
import { UserProfileUploadUpdateManyWithoutUserNestedInput } from '../user-profile-upload/user-profile-upload-update-many-without-user-nested.input';
...
@InputType()
export class UserUpdateWithoutMessageMentionInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    id?: StringFieldUpdateOperationsInput;

    @Field(() => UserProfileUploadUpdateManyWithoutUserNestedInput, {nullable:true})
    profileUploads?: UserProfileUploadUpdateManyWithoutUserNestedInput;
