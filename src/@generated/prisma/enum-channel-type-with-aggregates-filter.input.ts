...
import { NestedEnumChannelTypeWithAggregatesFilter } from './nested-enum-channel-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumChannelTypeFilter } from './nested-enum-channel-type-filter.input';

@InputType()
export class EnumChannelTypeWithAggregatesFilter {
