...
import { NestedEnumUserRelationTypeWithAggregatesFilter } from './nested-enum-user-relation-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUserRelationTypeFilter } from './nested-enum-user-relation-type-filter.input';

@InputType()
export class EnumUserRelationTypeWithAggregatesFilter {
